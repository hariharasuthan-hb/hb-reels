...
class CmsPageDataTable extends BaseDataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->addColumn('action', function ($page) {
                $editUrl = route('admin.cms.pages.edit', $page->id);
                $showUrl = route('admin.cms.pages.show', $page->id);
                $deleteUrl = route('admin.cms.pages.destroy', $page->id);
