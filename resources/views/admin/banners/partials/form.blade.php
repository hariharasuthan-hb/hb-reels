    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        ...
        <div>
            ...
            <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">
                {{ isset($banner) && $banner && $banner->image ? 'Replace Image' : 'Upload Image' }}
                @if(!isset($banner) || !$banner || !$banner->image)<span class="text-red-500">*</span>@endif
            </label>
            <input type="file"
                   name="image"
                   id="image"
                   accept="image/*"
                   {{ !isset($banner) || !$banner || !$banner->image ? 'required' : '' }}
            ...
            @else
                <p class="mt-2 text-xs text-gray-500">Recommended: 1920x800px or larger, max 5MB. JPG, PNG, GIF, SVG, or WebP.</p>
            @endif
            <div id="image-preview" class="mt-4 hidden">
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ isset($banner) && $banner && $banner->image ? 'New Image Preview' : 'Image Preview' }}</label>
    ...
    <div class="bg-gradient-to-r from-orange-50 to-amber-50 p-6 rounded-xl border border-orange-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-1">
                ...
                <p class="mt-1 text-xs text-gray-500">Only active banners are displayed on the frontend</p>
            </div>
        </div>
