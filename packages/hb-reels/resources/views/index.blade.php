    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
            ...
            <form action="{{ route(config('eventreel.route_name_prefix') . 'generate') }}" method="POST" enctype="multipart/form-data" id="reel-form">
                ...
                {{-- Text Input --}}
                <div class="mb-6">
                    <label for="event_text" class="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <textarea 
                        ...
                        placeholder="Or, paste event description, name, time, date, etc."
                    >{{ old('event_text') }}</textarea>
                </div>
